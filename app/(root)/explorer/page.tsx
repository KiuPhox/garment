...
const Explorer = () => {
  ...
  const handleDragEnd = (e: DragEndEvent) => {
    ...
    if (e.active.data.current?.type === "tagClassAreaSwitch") {
      const { tagClass: sourceTagClass, tagAreaId: sourceTagAreaId } = e.active
        .data.current as { tagClass: TagClass; tagAreaId: number };
      const { tagClass: targetTagClass, tagAreaId: targetTagAreaId } = e.over
        .data.current as { tagClass: TagClass; tagAreaId: number };
