import type { FileContainerProps } from '@/types/explorer'
    ...
    return (
        <div className="flex bg-[#414451] rounded-md gap-2 pr-4">
            ...
            <div className="flex justify-between flex-1 py-2">
                ...
                <div className="flex gap-4">
                    <Image src="/icons/download.svg" width={20} height={20} alt="download" className="cursor-pointer" />
                    <Image src="/icons/pencil.svg" width={20} height={20} alt="edit" className="cursor-pointer" />
                </div>
            </div>
        </div>
    )
